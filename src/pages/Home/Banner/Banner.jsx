...
const Banner = () => {
  return (
    <Carousel>
      <div>
        <img src={sliderImg1} className="rounded-lg"/>
      </div>
      <div>
        <img src={sliderImg2} className="rounded-lg"/>
      </div>
      <div>
        <img src={sliderImg3} className="rounded-lg"/>
      </div>
      <div>
        <img src={sliderImg4} className="rounded-lg"/>
      </div>
      <div>
        <img src={sliderImg5} className="rounded-lg"/>
      </div>
      <div>
        <img src={sliderImg6} className="rounded-lg"/>
      </div>
    </Carousel>
  );
};
